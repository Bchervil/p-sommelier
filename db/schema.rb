...
ActiveRecord::Schema.define(version: 2019_01_23_120506) do
  ...
  create_table "aromas_sides", id: false, force: :cascade do |t|
    ...
    t.index ["aroma_id"], name: "index_aromas_sides_on_aroma_id"
    t.index ["side_id"], name: "index_aromas_sides_on_side_id"
  end

  create_table "aromas_wines", id: false, force: :cascade do |t|
    t.integer "aroma_id", limit: 4
    t.integer "wine_id", limit: 4
    t.index ["aroma_id"], name: "index_aromas_wines_on_aroma_id"
    t.index ["wine_id"], name: "index_aromas_wines_on_wine_id"
  end
  ...
  create_table "dishes", force: :cascade do |t|
    ...
    t.index ["cooking_method_id"], name: "index_dishes_on_cooking_method_id"
    t.index ["ingredient_id"], name: "index_dishes_on_ingredient_id"
    t.index ["sauce_id"], name: "index_dishes_on_sauce_id"
  ...
  create_table "dishes_sides", id: false, force: :cascade do |t|
    ...
    t.integer "side_id", limit: 4
    t.index ["dish_id"], name: "index_dishes_sides_on_dish_id"
    t.index ["side_id"], name: "index_dishes_sides_on_side_id"
  end
